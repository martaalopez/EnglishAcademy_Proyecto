<aside class="sidebar" id="mainSidebar">
    ...
    <nav class="sidebar__nav">
        ...
        <a href="{{ route('dashboard.alumno') }}" class="sidebar__link sidebar__link--active">
        ...
        <a href="{{ route('resultados.index') }}" class="sidebar__link">
            <i class="fas fa-chart-bar"></i>
            <span class="sidebar__link-text">Mis Resultados</span>
        </a>

        <a href="{{ route('usuarios.show', Auth::user()->id) }}" class="sidebar__link">
